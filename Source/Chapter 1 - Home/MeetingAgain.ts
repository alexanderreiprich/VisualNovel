namespace Endabgabe {
  export async function MeetingAgain(): ƒS.SceneReturn {
    ...
    await ƒS.Speech.tell(characters.catname, text.Cat.T0001);
    await ƒS.Speech.tell(characters.narrator, text.Narrator.T0005);

    await ƒS.Character.hide(characters.catname);
    await ƒS.Character.show(characters.catname, characters.catname.pose.surprised, ƒS.positions.bottomcenter);
    await ƒS.update(0.2);
    await ƒS.Speech.tell(characters.catname, text.Cat.T0002);
    await ƒS.Speech.tell(characters.protagonist, text.Protagonist.T0001);

    await ƒS.Character.hide(characters.catname);
    await ƒS.Character.show(characters.catname, characters.catname.pose.curious, ƒS.positions.bottomcenter);
    await ƒS.update(0.2);
    await ƒS.Speech.tell(characters.catname, text.Cat.T0003);
    ...
    await ƒS.Character.show(characters.catname, characters.catname.pose.happy, ƒS.positions.bottomcenter);
    await ƒS.update(0.2);
    await ƒS.Speech.tell(characters.catname, name + text.Cat.T0004);
    await ƒS.Speech.tell(characters.protagonist, text.Protagonist.T0002);
    await ƒS.Speech.tell(characters.catname, text.Cat.T0005);
    await ƒS.Speech.tell(characters.narrator, text.Narrator.T0006);
    await ƒS.Speech.tell(characters.protagonist, text.Protagonist.T0003);

    await ƒS.Character.hide(characters.catname);
    await ƒS.Character.show(characters.catname, characters.catname.pose.neutral, ƒS.positions.bottomcenter);
    await ƒS.update(0.2);
    await ƒS.Speech.tell(characters.catname, text.Cat.T0006);
    await ƒS.Speech.tell(characters.protagonist, text.Protagonist.T0004);
  
    await ƒS.Character.hide(characters.catname);
    await ƒS.Character.show(characters.catname, characters.catname.pose.sad, ƒS.positions.bottomcenter);
    await ƒS.update(0.2);
    await ƒS.Speech.tell(characters.catname, text.Cat.T0007);
    await ƒS.Speech.tell(characters.narrator, text.Narrator.T0007);
    await ƒS.Speech.tell(characters.catname, text.Cat.T0008);
    await ƒS.Speech.tell(characters.protagonist, text.Protagonist.T0005);

    await ƒS.Character.hide(characters.catname);
    await ƒS.Character.show(characters.catname, characters.catname.pose.happy, ƒS.positions.bottomcenter);
    await ƒS.update(0.2);
    await ƒS.Speech.tell(characters.catname, text.Cat.T0009);
